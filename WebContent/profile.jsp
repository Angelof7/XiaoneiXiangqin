...
<meta name="description"
	content="南大旗下婚恋交友约会平台，优质单身男女全部身份验证，可安全交友。在花田免费交友，看信发信完全免费，同城交友精准推荐。来花田交友约会最靠谱！" />
<meta property="og:site_name" content="南大唯一免费的大型婚恋交友社区" />
<meta property="og:type" content="webpage" />
<!--主页链接-->
<meta property="og:image"
	content="http://img2.cache.netease.com/love/image/logo/open_graph_logo.png" />
...
<script type="text/javascript">
	...
	function check() {
		...
		if (!document.getElementById("mgender").checked
				&& !document.getElementById("wgender").checked) {
			alert('您的性别呢?');
			return false;
		}
		var regx = /^(?:[1-9][0-9]?|1[01][0-9]|120)$/; //^表示不匹配。d表示任意数字
		if (!regx.test(document.getElementById("age").value)) {
			alert("请输入你正确的年龄");
...
<body class="pSignup" data-log="pSignup">
	<form action="profile" onSubmit="return check();">
		<header class="header">
		...
		<div class="content">
			<div class="signup-titleBox">
				<h2>欢迎来到南大软院旗下婚恋交友社区！</h2>
				<span class="signup-title-slogan">一步完成注册，开启寻爱之旅</span>
			...
			<div class="mainBox">
				...
				<div id="regOptions" class="form-group signup-group">
					...
					<div class="form-row js-row">
						...
						<div class="form-control">
							<div class="form-input-wrapper">
								<label class="form-input-label text-gray js-nickNameLabel"
									style="display: none;">限12个汉字或24个英文字母</label> <input
									class="form-input js-nickName" name="nickname" id="nickName"
									type="text" onchange=changeName() onblur="checkBlur(this.id)" /><span></span>
							</div>
						</div>
						<div class="form-tips">
					...
					<div class="form-row js-row">
						...
						<div class="form-control">
							<div class="form-radioGroup">
								<label class="form-radio"><input name="sex" id="mgender"
									type="radio" value="0" /><span class="form-radio-label">男</span></label>
								<label class="form-radio"><input name="sex" id="wgender"
									type="radio" value="1" /><span class="form-radio-label">女</span></label>
							</div>
						</div>
						<div class="form-tips">
					...
					<div class="form-row js-row">
						<label class="form-label"><span class="form-need">*</span><span
							class="label-justify-text4">月均收入</span>：</label>
						<div class="form-control">
					...
					<div class="form-row js-row">
						...
						<div class="form-control">
							<input type="checkbox" checked="checked"
								class="form-checkbox js-agreeCheckBox" id="agree" /><a
								target="_blank" href="/protocol" class="form-checkbox-label">我同意网交友服务条款</a>
						</div>
					</div>
